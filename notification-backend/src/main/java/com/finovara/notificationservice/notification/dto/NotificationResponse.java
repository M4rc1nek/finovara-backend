...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = PiggyBankReachedDto.class, name = "PIGGY_BANK_GOAL_REACHED"),
        ...
        @JsonSubTypes.Type(value = RecurringExecutionSkippedDto.class, name = "RECURRING_EXECUTION_SKIPPED")
})

...
public class NotifyEmailChangeService extends AbstractNotificationEmailService {
    ...
    public NotifyEmailChangeService(NotificationEmailSettingsRepository notificationEmailSettingsRepository, NotificationSettingEmailSender notificationSettingEmailSender, AuthBackendClient authBackendClient, EmailNotifier emailNotifier, KafkaTemplate<String, Object> kafkaTemplate, AdditionalAuthorizationCodeResolver additionalAuthorizationCodeResolver) {
    ...
    protected void sendEmailToUser(Long userId, UserEmailDataDto userEmailData) {
        emailNotifier.send(ActionEmailNotificationType.EMAIL_CHANGED, userEmailData.email(),

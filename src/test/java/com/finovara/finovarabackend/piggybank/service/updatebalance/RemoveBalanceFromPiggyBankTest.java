...
class RemoveBalanceFromPiggyBankTest {
    ...
    void shouldRemoveBalanceSuccessfully() {
        ...
        piggyBankService.removeBalanceFromPiggyBank(email, piggyBankId, amount);
        ...
        verify(piggyBankActivityService).createPaymentPiggyBankActivity(
                email,
                piggyBank,
                PiggyBankActivityType.AMOUNT_REMOVED_FROM_PIGGY_BANK,
                amount
        );
    ...
    @Test
    void shouldThrowWhenInsufficientFundsInPiggyBank() {
        String email = "test@test.com";
        Long piggyBankId = 1L;
        ...
        assertThrows(InvalidInputException.class, () -> piggyBankService.removeBalanceFromPiggyBank(email, piggyBankId, new BigDecimal("100")));
    ...
    void shouldThrowExceptionWhenUserNotFound() {
        ...
        assertThrows(UserNotFoundException.class, () -> piggyBankService.removeBalanceFromPiggyBank(email, piggyBankId, new BigDecimal("100")));
    ...
    @Test
    void shouldUpdateProgressAfterRemoval() {
        String email = "test@test.com";
        Long piggyBankId = 1L;
        ...
        wallet.setBalance(new BigDecimal("300"));
        PiggyBank piggyBank = new PiggyBank();
        piggyBank.setAmount(new BigDecimal("500"));
        ...
        piggyBankService.removeBalanceFromPiggyBank(email, piggyBankId, new BigDecimal("200"));

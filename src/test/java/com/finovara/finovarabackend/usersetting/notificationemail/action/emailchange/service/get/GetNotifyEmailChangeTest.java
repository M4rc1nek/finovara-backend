package com.finovara.finovarabackend.usersetting.notificationemail.action.emailchange.service.get;
...
class GetNotifyEmailChangeTest {
    ...
    void shouldReturnNotificationFlagBasedOnSettings(boolean enabled) {
        ...
        NotificationEmailDto dto = notifyEmailChangeService.getEmailNotification(USER_ID);

package com.finovara.authbackend.settings.finances.recurring.service.support;
...
class RecurringSettingsSupportTest {
    ...
    void shouldReturnSettings() {
        ...
        when(recurringSettingsRepository.findByUserIdAndType(userId, RecurringType.REVENUE)).
        ...
        verify(recurringSettingsRepository).findByUserIdAndType(userId, RecurringType.REVENUE);
    }
    ...
    void shouldThrowExceptionWhenSettingsNotFound() {
        ...
        when(recurringSettingsRepository.findByUserIdAndType(userId, RecurringType.EXPENSE)).thenReturn(Optional.empty());

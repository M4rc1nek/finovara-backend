...
class WeeklyFinanceDigestReportMapperTest {
    ...
    private WeeklyFinanceDigestReportMapper mapper;

    @BeforeEach
    void setUp() {
        mapper = new WeeklyFinanceDigestReportMapper();
    }
    ...
    class ToDto {
        ...
        void shouldMapAllExpenseFieldsCorrectly() {
            ...
            WeeklyFinanceDigestReportDto result = mapper.toDto(USER_ID, FROM, TO, expenseSummary, revenueSummary, piggyBankSummaryDto());
